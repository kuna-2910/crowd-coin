...
class CampaignShow extends Component {
  ...
  renderCards(){
    ...
    const items = [
      ...
      {
        header:manager,
        meta: 'Address of project manager',
        description: 'The project manager created the campaign and can create requests to withdraw money. ',
      ...
      },
      {
        ...
        description:
          'You need to contribute at least this much wei to become an approver'
      },
      {
      ...
      },
      {
        ...
        description:
          'Number of people who have already supported and donated to this campaign'
      },
      {
